...
$landingPageID = get_connected_object_ID( $post->ID, 'proverb_lessons_to_topics' );
$currencyTypeID = get_connected_object_ID( $post->ID, 'proverb_lessons_to_topics', 'topics_to_modules', 'modules_to_units' );
