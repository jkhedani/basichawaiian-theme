	  ...
	  if ( response.success === true ) {
	  	...
	  	jQuery('body').append(response.html);
			...
			jQuery('#sceneModal .next').on('click',function(){
				...
				jQuery(this).parents('#sceneModal').find('.modal-count .modal-counter.current').removeClass('current').next().addClass('current');
				jQuery(this).parents('#sceneModal').find('.modal-count .modal-counter.viewed').next().addClass('viewed');
			});
			...
			jQuery('#sceneModal .prev').on('click',function(){
				...
				jQuery(this).parents('#sceneModal').find('.modal-count .modal-counter.viewed.current').removeClass('viewed');
				jQuery(this).parents('#sceneModal').find('.modal-count .modal-counter.current').removeClass('current').prev().addClass('current');
			});
