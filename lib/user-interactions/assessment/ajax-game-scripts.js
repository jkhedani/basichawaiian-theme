...
if ( $('body').hasClass('single-units') ) {
  ...
  $(document).on('click', '.carousel-indicator-control.right', function() {
    var activeIndicator = $('ol.carousel-indicators li').hasClass('active');
    activeIndicator.addClass('asdf');
    console.log(activeIndicator);
    if ( $('body .carousel-indicators li.active').hasClass('last') ) {
      $('body').find('.carousel-indicators li').removeClass('active');
      $('body').find('.carousel-indicators li.first').addClass('active');

    } else {
      $('body').find('.carousel-indicators li').removeClass('active').next().addClass('active');
    }
  });
  ...
  $('a.prompt-lesson-start').on('click', function() {
    ...
    var moduleNumber = $('body').find('.module.active').attr('data-module-number');
    ...
    $('#lesson-start-modal').find('.modal-footer a.start-lesson').attr( 'data-carousel-postion', moduleNumber ); // Update modal start with module number
  });
  ...
  $(document).on('click', 'ol.carousel-indicators li', function() {
    ...
    $('ul.modules li').removeClass('active');
    $('ol.carousel-indicators li[data-slide-to="'+slideTo+'"]').addClass('active');
    $('ul.modules li[data-slide-postion="'+slideTo+'"]').addClass('active');
  });
  ...
  var lessonID = $_GET["lesson"];
  var modulePos = $('li.lesson a[data-post-id="'+lessonID+'"]').attr('data-module-number');
  $('ol.carousel-indicators li[data-slide-to="'+modulePos+'"]').click();
}
...
if ( $('body').hasClass('single-phrases_lessons') || $('body').hasClass('single-chants_lessons') || $('body').hasClass('single-song_lessons') ) {
...
if ( $('body').hasClass('single-pronoun_lessons') || $('body').hasClass('single-phrases_lessons') || $('body').hasClass('single-vocabulary_lessons') || $('body').hasClass('single-song_lessons') || $('body').hasClass('single-chants_lessons') ) {
  ...
  var choiceHandler = function(e) {
    ...
    if ( $('body').hasClass('single-vocabulary_lessons') ) {
    ...
    } else if ( $('body').hasClass('single-phrases_lessons') || $('body').hasClass('single-chants_lessons') || $('body').hasClass('single-song_lessons') ) {
      ...
      var correctAnswerAudioMP3 = $(this).parent().find('.correct-option').data('correct-option-audio-mp3');
    } else {
      // Display appropriate feedback
      var correctAnswer = $(this).parent().find('.correct-option').text();
    }
    ...
    // If choice is incorrect...
      ...
      $('.lesson-feedback .pronunciation-container').append('<audio class="pronunciation"><source src="'+correctAnswerAudio+'" type="audio/ogg"><source src="'+correctAnswerAudioMP3+'" type="audio/mpeg"></audio>');
